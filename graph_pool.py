...
class SequenceEncoder(nn.Module):
    def __init__(self,input_dim,time_step,hidden_dim):
        ...
        # self.grup = [gru(1, 16) for _ in range(100)]
    ...
    def forward(self,seq):
        ...
        #     y,_ = self.grup[i](seq[i,:,:].reshape((1,7,1)))
        #     li.append(y.reshape(1,7,16))
        # seq_vector = torch.cat(li)
...
class CategoricalGraphAtt(nn.Module):
    ...
    def forward(self,weekly_batch):
        ...
        inner_graph_embedding = inner_graph_embedding.view(10,10,-1)

        # pooling 
        weekly_att_vector = weekly_att_vector.view(10,10,-1)
